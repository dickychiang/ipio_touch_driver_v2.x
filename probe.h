...
extern int ilitek_platform_probe(struct i2c_client *client, const struct i2c_device_id *id);
extern int ilitek_platform_remove(struct i2c_client *client);
#else
extern int ilitek_platform_probe(struct spi_device *spi);
extern int ilitek_platform_remove(struct spi_device *spi);
#endif
//compare
